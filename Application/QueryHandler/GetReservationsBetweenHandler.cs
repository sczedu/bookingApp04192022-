...
namespace Application.QueryHandler
{
    public class GetReservationsBetweenHandler : IRequestHandler<GetReservationsBetween, List<Reservation>>
    {
        ...
        {
            var reservationsStartsTask = _reservationRepository.GetReservationsStartsBetweenAsync(request.Starts, request.Ends, true);
            var reservationsEndsTask = _reservationRepository.GetReservationsEndsBetweenAsync(request.Starts, request.Ends, true);
